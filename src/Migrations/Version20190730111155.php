 ...
 */
final class Version20190730111155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE anime CHANGE season season INT NOT NULL, CHANGE type type INT NOT NULL, CHANGE kistsu_id kistu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE anime CHANGE season season INT DEFAULT NULL, CHANGE type type INT DEFAULT NULL, CHANGE kistu_id kistsu_id INT DEFAULT NULL');
